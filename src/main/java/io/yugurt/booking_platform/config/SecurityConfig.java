    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/rooms/*").hasRole("HOST")
                .requestMatchers(HttpMethod.DELETE, "/api/rooms/*").hasRole("HOST")

                // Reservation
                .requestMatchers(HttpMethod.POST, "/api/reservations").hasRole("GUEST")
                .requestMatchers(HttpMethod.GET, "/api/reservations")
                .hasAnyRole("GUEST", "HOST")
                .requestMatchers(HttpMethod.GET, "/api/reservations/*")
                .hasAnyRole("GUEST", "HOST")
                .requestMatchers(HttpMethod.DELETE, "/api/reservations/*").hasRole("GUEST")
